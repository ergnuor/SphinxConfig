...
namespace Ergnuor\SphinxConfigOld\Section\SourceConfig;

use Ergnuor\SphinxConfigOld\Exception\{Message as ExceptionMessage, ReaderException, SectionException};
use Ergnuor\SphinxConfigOld\Section\{Context, Reader};
