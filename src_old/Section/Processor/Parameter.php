...
namespace Ergnuor\SphinxConfigOld\Section\Processor;

use Ergnuor\SphinxConfigOld\Exception\{Message as ExceptionMessage, SectionException};
use Ergnuor\SphinxConfigOld\Section\{Context, Utility\ArrayUtility, Utility\Parameter as ParameterUtility};
