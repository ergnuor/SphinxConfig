...
namespace Ergnuor\SphinxConfigOld\Section;

use Ergnuor\SphinxConfigOld\Exception\{Message as ExceptionMessage, WriterException};
use Ergnuor\SphinxConfigOld\Section\{Utility\Type, Writer\Adapter as WriterAdapter};
